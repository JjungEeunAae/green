...
public class Mini {
	public static void main(String[] args) {
		...
		loop:while (true) {
			...
			switch (mainCategory) {
				case 0:
					System.out.println(BACKGROUND_WHITE+FONT_RED+"=================[ 프로그램을 종료합니다. ]================="+RESET);
					break loop;
				case 1:
					// 로그인
					...
					System.out.println(BACKGROUND_WHITE+FONT_GREEN+"                      로그인 성공!                       "+RESET);
					System.out.println(BACKGROUND_WHITE+FONT_BLUE+"==================[ OO님 환영합니다. ]==================="+RESET);
					mLoop:while (true) {
						...
						switch (middleCategory) {
							case 1:
								// 단어맞추기 기능(소분류 넣어야 함)
								System.out.println(BACKGROUND_WHITE+FONT_BLUE+"                       단어맞추기                      "+RESET);
								System.out.println(" -----------------[ 메뉴를 선택해주세요 ]--------------- ");
								...
								switch (gameCategory) {				// 입력받은 값으로 기능 굴리기
									...
									case 9:
										// 이전메뉴
										System.out.println(BACKGROUND_WHITE + FONT_GREEN + "=================[ 이전메뉴로 돌아갑니다. ]================="+RESET);
										break;
									case 0:
										// 종료
										System.out.println(BACKGROUND_WHITE + FONT_RED + "=================[ 프로그램을 종료합니다. ]================="+RESET);
							...
							case 3:
								// 방명록 기능(소분류 넣어야 함)
								System.out.println(BACKGROUND_WHITE+FONT_GREEN+"                        방 명 록                        "+RESET);
								System.out.println(" -----------------[ 메뉴를 선택해주세요 ]------------------");
							...
							case 8:
								...
								break mLoop;
							case 9:	// 탈퇴 시스템
								System.out.println(BACKGROUND_WHITE + FONT_GREEN + "               이대로 탈퇴를 이어가시겠습니까?                " + RESET);
									...
									case 1:
										...
										if(randomNumberCheck != random) {
											...
											if(randomNumberDoubleCheck != randomDouble) {
												System.out.println(BACKGROUND_BLACK + FONT_RED + "입력값이 올바르지 않습니다. 메뉴로 돌아갑니다" + RESET);
												break;
											} else {
												System.out.println(BACKGROUND_WHITE + FONT_GREEN + "                탈퇴완료! 처음으로 돌아갑니다.                " + RESET);
												break mLoop;
											}
